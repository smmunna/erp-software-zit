...
const EditDueFull = () => {
    ...
    return (
        <div className='min-h-screen dashbg'>
            <PageHeading title={`Edit Due Income `} />
            {
                !loading ?
                    <>
                                        ...
                                        <div>
                                            ...
                                            <div className=" p-3 lg:p-5 bg-white shadow my-4">
                                                ...
                                                <div className="form-control">
                                                    ...
                                                    <input type="email" name="email" defaultValue={allIncome.email} placeholder="Contact Number" className="input input-bordered" required />
                                                </div>
