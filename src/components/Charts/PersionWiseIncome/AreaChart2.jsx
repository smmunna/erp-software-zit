...
const AreaChart2 = () => {
    ...
    useEffect(() => {
        if (totalMarktingPersonIncome && totalMarktingPersonIncome.sales_by_person_currentYear) {
            // console.log(totalMarktingPersonIncome.sales_by_person_currentYear)
            const newData = totalMarktingPersonIncome.sales_by_person_currentYear.map(item => ({
