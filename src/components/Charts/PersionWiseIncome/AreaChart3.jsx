...
const AreaChart3 = () => {
    ...
    useEffect(() => {
        if (totalMarktingPersonIncome && totalMarktingPersonIncome.sales_by_person_prevYear) {
            // console.log(totalMarktingPersonIncome)
            const newData = totalMarktingPersonIncome.sales_by_person_prevYear.map(item => ({
