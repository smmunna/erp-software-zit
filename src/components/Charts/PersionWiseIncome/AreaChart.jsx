...
const AreaChart = () => {
    ...
    useEffect(() => {
        if (totalMarktingPersonIncome && totalMarktingPersonIncome.sales_by_person_currentMonth) {
            // console.log(totalMarktingPersonIncome)
            const newData = totalMarktingPersonIncome.sales_by_person_currentMonth.map(item => ({
        ...
        <div>
            <ResponsiveContainer width='100%' height={200}>
                ...
                >
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="profit" fill="#6DA7FF" activeBar={<Rectangle fill="pink" stroke="blue" />} />
                    <Bar dataKey="sales" fill="#FFC107" activeBar={<Rectangle fill="gold" stroke="purple" />} />
                </BarChart>
            </ResponsiveContainer>
        </div>
    );
